 ...
 * bug fix  **docs:** Появляется скрытое меню в документации на мобилке ([#DS-2397](https://github.com/koobiq/angular-components/issues/issue/DS-2397)) ([#14](https://github.com/koobiq/angular-components/issues/14)) ([4aea3af](https://github.com/koobiq/angular-components/commit/4aea3af5ef178511753db17fe913316e739b492d))
 * bug fix  **select, tree-select:** Не сбрасывается фокус с option (disabled=true) ([#DS-2409](https://github.com/koobiq/angular-components/issues/issue/DS-2409)) ([#6](https://github.com/koobiq/angular-components/issues/6)) ([0d65982](https://github.com/koobiq/angular-components/commit/0d659829e386aaf51443e2eca818d4746a99b9b1))
 * bug fix  **select:** Кнопка кликается со второго раза ([#DS-2443](https://github.com/koobiq/angular-components/issues/issue/DS-2443)) ([#9](https://github.com/koobiq/angular-components/issues/9)) ([3adf99c](https://github.com/koobiq/angular-components/commit/3adf99c19ef9504e5cc16a53939db2f2c247176f))
 * bug fix  **select:** Не выделяется единственный элемент в результатах поиска ([#DS-2450](https://github.com/koobiq/angular-components/issues/issue/DS-2450)) ([#13](https://github.com/koobiq/angular-components/issues/13)) ([182b0d5](https://github.com/koobiq/angular-components/commit/182b0d57687f6edf579e934e66853208b989a2d1))
