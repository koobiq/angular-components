 ...
 * bug fix  **core:** escape HTML in `KbqHighlightPipe` ([#DS-4692](https://github.com/koobiq/angular-components/issues/issue/DS-4692)) ([#1364](https://github.com/koobiq/angular-components/issues/1364)) ([427290e](https://github.com/koobiq/angular-components/commit/427290efccbd4edd20f197240b0d457785a3f74a))
 * bug fix  **datepicker:** popup position ([#DS-4619](https://github.com/koobiq/angular-components/issues/issue/DS-4619)) ([#1326](https://github.com/koobiq/angular-components/issues/1326)) ([83a5afc](https://github.com/koobiq/angular-components/commit/83a5afc0af126ddf04de562cb0f1f49c4ab28c7e))
 * bug fix  **dropdown:** don't overlay trigger if dropdown isn't fit ([#DS-4505](https://github.com/koobiq/angular-components/issues/issue/DS-4505)) ([#1335](https://github.com/koobiq/angular-components/issues/1335)) ([6ebb775](https://github.com/koobiq/angular-components/commit/6ebb7757806519955da168964560f771faf889ed))
 * bug fix  **filter-bar:** select children using search ([#DS-4613](https://github.com/koobiq/angular-components/issues/issue/DS-4613)) ([#1328](https://github.com/koobiq/angular-components/issues/1328)) ([08fa4e4](https://github.com/koobiq/angular-components/commit/08fa4e492149084466a5a2ce33136b5311e6b89d))
 * bug fix  **form-field:** inner focus frame ([#DS-4671](https://github.com/koobiq/angular-components/issues/issue/DS-4671)) ([#1373](https://github.com/koobiq/angular-components/issues/1373)) ([371d42b](https://github.com/koobiq/angular-components/commit/371d42b23a4bb98302ef76046d289cec2fe5414e))
 * bug fix  **icon:** disabled state for icon-button ([#DS-4625](https://github.com/koobiq/angular-components/issues/issue/DS-4625)) ([#1363](https://github.com/koobiq/angular-components/issues/1363)) ([19944f9](https://github.com/koobiq/angular-components/commit/19944f90e3e822092e21d35511a05f60ca887c5f))
 * bug fix  **inline-edit:** aligned vertical paddings ([#DS-4656](https://github.com/koobiq/angular-components/issues/issue/DS-4656)) ([#1366](https://github.com/koobiq/angular-components/issues/1366)) ([8cb420c](https://github.com/koobiq/angular-components/commit/8cb420c72dcc3a50495afe7f66ad5112df91a21e))
 * bug fix  **inline-edit:** removed text flick on mode change ([#DS-4360](https://github.com/koobiq/angular-components/issues/issue/DS-4360)) ([#1333](https://github.com/koobiq/angular-components/issues/1333)) ([ac6349d](https://github.com/koobiq/angular-components/commit/ac6349d68d1e2f2368430510374db50e7dae2c0b))
 * bug fix  **input:** borders appear when autofilling ([#DS-4667](https://github.com/koobiq/angular-components/issues/issue/DS-4667)) ([#1357](https://github.com/koobiq/angular-components/issues/1357)) ([cf6d6e9](https://github.com/koobiq/angular-components/commit/cf6d6e92b547e0173678641971bc0954cc387f69))
 * bug fix  **list:** focus state after closing ([#DS-4673](https://github.com/koobiq/angular-components/issues/issue/DS-4673)) ([#1362](https://github.com/koobiq/angular-components/issues/1362)) ([a39eab8](https://github.com/koobiq/angular-components/commit/a39eab82af876e158f75df7274067641da731242))
 * bug fix  **list:** selected value is reset when scrolling (virtual scroll) ([#DS-4670](https://github.com/koobiq/angular-components/issues/issue/DS-4670)) ([#1361](https://github.com/koobiq/angular-components/issues/1361)) ([c51aba3](https://github.com/koobiq/angular-components/commit/c51aba3097aa6c41609cb0dc43fe4ca0e05d786f))
 * bug fix  **popover:** inverted background of close button without header ([#DS-3185](https://github.com/koobiq/angular-components/issues/issue/DS-3185)) ([#1323](https://github.com/koobiq/angular-components/issues/1323)) ([481acee](https://github.com/koobiq/angular-components/commit/481acee2aac138bfd951552f3f8fec5305d65198))
 * bug fix  **search-expandable:** added control states at the input ([#DS-4680](https://github.com/koobiq/angular-components/issues/issue/DS-4680)) ([#1367](https://github.com/koobiq/angular-components/issues/1367)) ([20d0b26](https://github.com/koobiq/angular-components/commit/20d0b261fb81c6785c3da75288a03d3232fe4838))
 * bug fix  **search-expandable:** added disabled state ([#DS-4690](https://github.com/koobiq/angular-components/issues/issue/DS-4690)) ([#1368](https://github.com/koobiq/angular-components/issues/1368)) ([867608a](https://github.com/koobiq/angular-components/commit/867608a60d1d788a3ab64d52221c70cf39a1d230))
 * bug fix  **select:** color for disabled state ([#DS-4574](https://github.com/koobiq/angular-components/issues/issue/DS-4574)) ([#1330](https://github.com/koobiq/angular-components/issues/1330)) ([170d5c3](https://github.com/koobiq/angular-components/commit/170d5c356865b77dea85e5d9e3f00d24ac47aca3))
 * bug fix  **select:** return focus on search with virtual scroll ([#DS-4637](https://github.com/koobiq/angular-components/issues/issue/DS-4637)) ([#1360](https://github.com/koobiq/angular-components/issues/1360)) ([b5c4b9f](https://github.com/koobiq/angular-components/commit/b5c4b9f8b4aa46cd06a3723a874869a4bdf4ba9f))
 * bug fix  **select:** scrollBar jumps in select with virtual scrolling ([#DS-4621](https://github.com/koobiq/angular-components/issues/issue/DS-4621)) ([#1354](https://github.com/koobiq/angular-components/issues/1354)) ([520d15f](https://github.com/koobiq/angular-components/commit/520d15faccc03e58454b7c967f14824fa6e5299b))
 * bug fix  **tags:** add emitOnTagChanges to control change emissions ([#DS-4634](https://github.com/koobiq/angular-components/issues/issue/DS-4634)) ([#1372](https://github.com/koobiq/angular-components/issues/1372)) ([c321011](https://github.com/koobiq/angular-components/commit/c321011b535f06790ee506db3b4dbc2819b9be8d))
 * bug fix  **tags:** double focus when editing ([#DS-4321](https://github.com/koobiq/angular-components/issues/issue/DS-4321)) ([#1324](https://github.com/koobiq/angular-components/issues/1324)) ([23aae85](https://github.com/koobiq/angular-components/commit/23aae85be5149676ac3733350313609438672c0a))
 * bug fix  **tags:** filter on paste ([#DS-4611](https://github.com/koobiq/angular-components/issues/issue/DS-4611)) ([#1374](https://github.com/koobiq/angular-components/issues/1374)) ([b281100](https://github.com/koobiq/angular-components/commit/b2811009e3afb23715292169b59a8b660524c50b))
 * bug fix  **tags:** focusout on editing tag click ([#DS-4677](https://github.com/koobiq/angular-components/issues/issue/DS-4677)) ([#1356](https://github.com/koobiq/angular-components/issues/1356)) ([592af81](https://github.com/koobiq/angular-components/commit/592af8113baea16e6914e1c2706778aa3b9ceb6f))
