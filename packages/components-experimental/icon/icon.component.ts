...
import { injectKbqIconConfig } from './icon-config.provider';
import { injectKbqIcons } from './icon.provider';
...
export class KbqIcon implements OnInit, OnChanges {
    private readonly iconConfig = injectKbqIconConfig();
    private readonly icons = injectKbqIcons();
