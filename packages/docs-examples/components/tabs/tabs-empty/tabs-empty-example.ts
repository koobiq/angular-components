        ...
        <div class="tabs-empty-example">
            <kbq-tab-group>
                <kbq-tab [label]="'Bruteforce'">
                    <div class="empty-tab-content">Зарегистрировано 1005 инцидентов</div>
                </kbq-tab>
                ...
                <kbq-tab [label]="'DoS'">
                    ...
                    <p>
                        // eslint-disable-next-line no-irregular-whitespace Eсли которого, наслаждений какими отвергает
                        предпочел: что человек когда некое порицающих - такие раскрою наслаждения счастливой наслаждения
                        - если что говорил. Никто возлюбил бы справедливости порицающих всю кто несло: наслаждению, стал
                        нас неприятностей некоей только я не. По когда вами было возлюбил, картину eсли из-за
                        обстоятельства, чтобы никаких истину примером. Нас какими отвергает человек никакого возлюбил
                        стал, обстоятельства разумно отвергает нас людей за: что умеет упрекнуть обстоятельства но
                        примером порицающих. Умеет я примером истину eсли приносят, некое, открывший картину
                        обстоятельства возникают. Разъясню никаких, было наслаждений или перед из справедливости истину
                        стремящегося всю несло пользы если когда наслаждение только наслаждения eсли я никаких избегает.
                        Приносят eсли, умеет и только тех восхваляющих и из-за картину, лишь вы.
                    </p>
                </kbq-tab>
            </kbq-tab-group>
        </div>
