...
export class FilterBarOverviewExample {
    ...
    // that binding, so a relabelled period only reaches the screen as a new pipe object. `linkedSignal`
    // for what the user also writes, `computed` for what is only ever read.
