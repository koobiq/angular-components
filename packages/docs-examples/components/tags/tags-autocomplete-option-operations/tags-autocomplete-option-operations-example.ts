...
@Component({
    ...
    templateUrl: 'tags-autocomplete-option-operations-example.html',
    styleUrls: ['tags-autocomplete-option-operations-example.css'],
    encapsulation: ViewEncapsulation.None
})
export class TagsAutocompleteOptionOperationsExample {
