...
@Component({
    ...
    template: `
        ...
        <kbq-toggle>
            Vibration
            <kbq-hint>
                When this witch is off, all vibration on your phone will be disabled, including those for earthquake,
                tsunami and other emergency alerts.
            </kbq-hint>
        </kbq-toggle>
    `,
    styles: `
    ...
    `,
    host: {
        class: 'layout-align-center-start layout-column layout-gap-s layout-padding-top-l layout-padding-bottom-3xl'
    },
