...
import { LEFT_ARROW, RIGHT_ARROW, SPACE, ENTER, DOWN_ARROW } from '@koobiq/cdk/keycodes';
...
export const KBQ_DROPDOWN_SCROLL_STRATEGY =
    new InjectionToken<() => ScrollStrategy>('kbq-dropdown-scroll-strategy');
