...
import { DOWN_ARROW, ENTER, ESCAPE, LEFT_ARROW, RIGHT_ARROW, TAB } from '@koobiq/cdk/keycodes';
import {
    MockNgZone,
    createKeyboardEvent,
    createMouseEvent,
...
describe('KbqDropdown', () => {
    ...
    it('should focus the panel instead of the first item when opening by mouse', fakeAsync(() => {
        ...
        fixture.detectChanges();
        const focusSpyFn = jest.spyOn(fixture.componentInstance.items.first, 'focus');
