...
@Component({
    ...
    template: `
        <button kbq-button type="button">
            <!-- comment-before -->
            <i kbq-icon="kbq-angle-down_16"></i>
            <!-- comment-after -->
        </button>
    `
})
...
@Component({
    ...
    template: `
        <button kbq-button type="button">
            <i kbq-icon="kbq-angle-down_16" *ngIf="visible"></i>
            Some text
        </button>
    `
})
...
@Component({
    ...
    template: `
        <button kbq-button type="button">
            <i id="icon1" kbq-icon="kbq-angle-down_16"></i>
            <i id="icon2" kbq-icon="kbq-angle-down_16"></i>
        </button>
    `
})
