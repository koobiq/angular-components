...
Кнопка сброса очищает все, кроме неактивных узлов. Эту логику можно изменить параметром `clearPredicate`: с `[clearPredicate]="clearEverything"` и `clearEverything = () => true` очищаются и неактивные.
