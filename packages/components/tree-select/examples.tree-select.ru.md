...
Показывает, как обрабатывать выбранные значения, узлы которых были удалены на бэкенде: удалённые узлы скрыты из выпадающего списка, но остаются в выборе в виде удаляемых тегов с ошибкой, поле становится невалидным, пока выбрано хотя бы одно удалённое значение, а подсказка объясняет причину.
