...
<div style="margin-top: 15px;">
    <img src="./assets/images/tree-select/tree-select__structure.png" alt="tree-select" style="max-width: 531px" />
</div>
...
<Example id="tree-filtering" />

#### List with tree and filtering of selected items

<Example id="tree-checked-filtering" />
...
<Example id="tree-action-button" />

#### Caption in options

<Example id="tree-select-two-line-option" />
