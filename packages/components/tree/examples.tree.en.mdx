...
<Example id="tree-custom-filtering" />
...
<Example id="tree-descendants-subcategories" />
...
<Example id="tree-select-and-mark" />
...
<Example id="tree-selection-separate-from-focus" />
...
<Example id="tree-toggle-on-click" />
