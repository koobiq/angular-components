...
`KbqTabNavBar` — это компонент, который используется для создания навигационной панели с вкладками, который позволяет пользователям переключаться между различными представлениями или маршрутами в приложении, используя вкладки в качестве интерфейса.
