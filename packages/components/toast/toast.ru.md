...
Автоматическое скрытие приостанавливают только ховер и фокус. Пользователь скринридера, читающий виртуальным курсором, не двигает ни то ни другое, поэтому тост с действием или сообщением об ошибке следует показывать с `duration: 0` и закрывать явно.
