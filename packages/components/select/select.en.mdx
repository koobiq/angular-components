...
<Example id="select-overview" />

### States

#### Validation

<Example id="select-validation" />

#### Inactive states

<Example id="select-disabled" />
...
<Example id="select-cleaner-with-disabled" />
...
<Example id="select-multiple" />

#### Multiple selection (multiline)

<Example id="select-with-multiline-matcher" />
...
<Example id="select-select-all-label" />
...
<Example id="select-with-panel-width-default" />
...
<Example id="select-with-panel-min-width" />
...
<Example id="select-with-panel-width-auto" />
...
<Example id="select-with-panel-width-fixed" />
...
<Example id="select-preselected-values" />

To make navigation easier, selected items can be pinned to the top of the list.

<Example id="select-prioritized-selected" />

### Optional icon

<Example id="select-icon" />
...
<Example id="select-virtual-scroll" />
...
<Example id="select-scrolling-and-layering" />

### Caption in options

<Example id="select-two-line-option" />
...
<Example id="select-locale-configuration" />
