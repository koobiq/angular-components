...
При открытой панели `Tab` переводит фокус на содержимое колонтитула — по очереди на каждый интерактивный элемент, будь то строка действия или ссылка. Когда они кончаются, следующий `Tab` закрывает панель и возвращает фокус на поле.
