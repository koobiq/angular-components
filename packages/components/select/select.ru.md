...
По умолчанию выпадающее меню скрывается под горизонтальный [Navbar](/ru/components/navbar) и [Topbar](/ru/components/topbar), в остальных случаях показывается поверх соседних элементов.
