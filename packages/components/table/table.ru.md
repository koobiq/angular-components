...
Используйте `[disableHover]="true"`, чтобы убрать изменение цвета фона строки при наведении. Это полезно, когда строки не являются интерактивными и подсветка при наведении может вводить в заблуждение.
