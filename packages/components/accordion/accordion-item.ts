...
export class KbqAccordionItem implements OnDestroy {
    ...
    constructor() {
        ...
        afterNextRender(() => {
            this.accordion.saveItemState(this.id, this);
        });

        afterNextRender({
            write: () => {
                this.expanded = this.accordion.state[this.id].expanded;
                console.log('kbq-accordion-item Directive afterNextRender write: ');
            },
            read: () => {
                console.log('kbq-accordion-item Directive afterNextRender read: ');
            }
        });
    }
