...
Аккордеон запоминает, какие секции были раскрыты, и восстанавливает их при следующей отрисовке. Включено по умолчанию — передайте `[useStateSaving]="false"`, если начальным состоянием распоряжается приложение.
