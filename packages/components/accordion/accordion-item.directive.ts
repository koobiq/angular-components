...
import { KbqAccordionOrientation, KbqAccordionRootToken } from './accordion-root.directive';
...
export class KbqAccordionItemDirective implements FocusableOption, OnDestroy {
    /** @docs-private */
    protected readonly accordion = inject(KbqAccordionRootToken, { skipSelf: true });
    /** @docs-private */
     ...
     * @docs-private
     */
    readonly id: string = `kbq-accordion-item-${nextId++}`;
