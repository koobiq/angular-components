...
В теле окна может располагаться форма. Терминальные кнопки отправки формы должны располагаться в подвале окна. [Валидация подчиняется общим правилам](/components/validation/overview).
