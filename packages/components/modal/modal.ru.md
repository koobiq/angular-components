...
Используйте подпись, чтобы добавить дополнительный контекст под заголовком диалога - например, краткое описание действия или его области применения. Подпись ограничена двумя строками и обрезается многоточием, если текст длиннее.
