...
describe('KbqInput', () => {
    ...
    describe('basic behaviors', () => {
        ...
        it('should has cleaner', () => {
            ...
            expect(formFieldElement.querySelectorAll('.kbq-form-field__cleaner').length)
                .toBe(0);
    ...
    describe('apperance', () => {
        ...
        it('should has hint', fakeAsync(() => {
            ...
            expect(formFieldElement.querySelectorAll('.kbq-form-field__hint').length)
                .toBe(1);
            expect(formFieldElement.querySelectorAll('.kbq-form-field__hint')[0].textContent)
                .toBe('Hint');
        }));

        it('should has prefix', () => {
            const fixture = createComponent(KbqFormFieldWithPrefix, [
                KbqIconModule
            ]);
            fixture.detectChanges();
            ...
            expect(formFieldElement.querySelectorAll('.kbq-form-field__prefix').length)
                .toBe(1);
            expect(formFieldElement.querySelectorAll('[kbq-icon]').length)
                .toBe(1);
        });

        it('should has suffix', () => {
            const fixture = createComponent(KbqFormFieldWithSuffix, [
                KbqIconModule
            ]);
            fixture.detectChanges();
            ...
            expect(formFieldElement.querySelectorAll('.kbq-form-field__suffix').length)
                .toBe(1);
            expect(formFieldElement.querySelectorAll('[kbq-icon]').length)
                .toBe(1);
        });
