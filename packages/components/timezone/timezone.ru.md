...
Пример выше сопоставляет весь запрос как одну строку: слова должны идти в том же порядке, что и в тексте. В примере ниже каждое слово запроса сопоставляется независимо. Подробнее — в гайде [Умный поиск](/ru/main/search-smart).
