...
-   Если нужно встроить кнопку в текст. В таком случае используется [псевдоссылка](/ru/components/link/overview#псевдоссылка)

#### Когда не нужно использовать ссылки

-   Для основного действия в модальном диалоге — используйте [кнопку](/ru/components/button)
-   Для интерактивности вне текста — используйте [кнопку без фона](/ru/components/button)
