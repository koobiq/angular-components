...
<Example id="loader-overlay-overview" />
...
<Example id="loader-overlay-default" />
...
<Example id="loader-overlay-background" />
...
<Example id="loader-overlay-fixed-top" />
...
<Example id="loader-overlay-large" />

#### Sizes

The component size is set using the `size` attribute.

<Example id="loader-overlay-size" />
