...
Если оверлей перекрывает только часть экрана, его край остается видимым. Переход выглядит бесшовным, когда цвет оверлея совпадает с поверхностью контейнера.
