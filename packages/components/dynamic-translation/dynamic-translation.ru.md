...
Строку компонент принимает уже переведённой: перевод — задача приложения. Строки, которые библиотека
выводит сама, к этому отношения не имеют, они описаны в разделе [Локализация](/ru/main/localization).
