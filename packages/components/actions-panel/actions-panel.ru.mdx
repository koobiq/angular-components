...
<Example id="actions-panel-overview" />
...
<Example id="actions-panel-adaptive" />
...
<Example id="actions-panel-custom-counter" />
...
<Example id="actions-panel-close" />
...
<Example id="actions-panel-global" />
