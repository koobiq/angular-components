...
<Example id="filter-bar-overview" />
...
<Example id="filter-bar-cleanable" />
...
<Example id="filter-bar-removable" />
...
<Example id="filter-bar-readonly-pipes" />

### Filter types

<Example id="filter-bar-pipe-types" />
...
<Example id="filter-bar-master-checkbox" />
...
<Example id="filter-bar-locked-options" />
...
<Example id="filter-bar-panel-max-height" />
...
<Example id="filter-bar-option-caption" />

### Inactive filter

The filter value cannot be changed or deleted.

<Example id="filter-bar-inactive-filter" />
...
<Example id="filter-bar-saved-filters" />
...
<Example id="filter-bar-state-saving" />
...
<Example id="filter-bar-localization" />
