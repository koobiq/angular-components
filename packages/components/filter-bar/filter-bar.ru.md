...
Приложения обычно загружают сохранённые фильтры с сервера, поэтому бар ждёт: фильтр, названный в сохранённом состоянии, восстанавливается, как только появляется в `filters`. Фильтр, чьего имени там больше нет, не восстанавливается, а ожидание прекращается, как только фильтр меняет что-то ещё.
