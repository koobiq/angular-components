...
При копировании значений из буфера или вставке их с помощью drag-and-drop срабатывает [валидация при потере фокуса](/other/validation/overview#по-уходу-с-поля-(по-потере-фокуса)).
