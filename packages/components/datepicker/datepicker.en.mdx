...
<Example id="datepicker-overview" />

### States

#### Inactive field

<Example id="datepicker-inactive" />

### Required

If the date field is required, use the `required` parameter.

<Example id="datepicker-required" />
