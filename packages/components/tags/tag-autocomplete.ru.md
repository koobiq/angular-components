...
Кнопка сброса предлагает удалить все теги, кроме неактивных. Удаляет их ваш обработчик: список отдаёт ему теги в `clearTargets`. Отбор можно изменить параметром `clearPredicate`.
