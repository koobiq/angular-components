...
<Example id="tag-autocomplete-overview" />
...
In a wide field the menu is easier to use next to the text being typed: set `kbqAutocompleteRelativeToCaret` on the input. The menu then opens from the caret, right below its line, and is only as wide as its options.

<Example id="tag-autocomplete-relative-to-caret" />
...
<Example id="tag-autocomplete-search" />
...
<Example id="tag-autocomplete-option-operations" />
...
<Example id="tag-autocomplete-removable" />
...
<Example id="tag-autocomplete-cleaner-with-disabled" />
...
<Example id="tag-autocomplete-with-form-control-validators" />
