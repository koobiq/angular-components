**Core** объединяет общие средства библиотеки Koobiq: настройки, типы, базовые элементы, правила взаимодействия и служебные утилиты. На них опираются готовые компоненты. Эти же средства можно использовать в собственных компонентах и обертках.
