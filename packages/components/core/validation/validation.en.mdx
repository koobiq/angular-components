...
<Example id="validation-optional-label" />
...
<Example id="validation-required-label" />
...
Used to check for valid characters. Invalid characters are filtered out during input, and an error tooltip is shown near the text caret. The message disappears when a valid character is entered or the field loses focus.

<Example id="validation-on-type" />
...
<Example id="validation-on-blur-filled" />
...
<Example id="validation-on-submit" />
...
<Example id="validation-message-global" />
...
<Example id="validation-message-global-with-links" />
