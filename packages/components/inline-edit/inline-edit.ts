...
import { concat, debounceTime, merge, Observable, of, skip, startWith, timer } from 'rxjs';
...
export class KbqInlineEdit implements KbqConnectedOverlayOriginProvider, KbqInlineEditSaveRecovery {
    ...
    readonly saveError = output<KbqInlineEditSaveErrorContext>();
    ...
    protected save($event?: Event): void {
        ...
        // background, and view mode reports how it went. Focus goes back with the mode, not with the response,
        // which lands long after the user has moved on.
        this.toggleMode();
        this.restoreFocus();
