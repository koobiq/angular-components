...
| `kbqRelativeToCaret`         | `boolean`                                     | `false`          | Positions the tooltip at the text caret of the field, following it as it moves. Wins over `kbqRelativeToPointer`.                              |
| `kbqRelativeToCaretVertical` | `'auto' \| 'line' \| 'field'`                 | `'auto'`         | Vertical anchor of a caret-relative tooltip: the whole field or the caret line. `auto` picks `field` for an `input`.                           |
