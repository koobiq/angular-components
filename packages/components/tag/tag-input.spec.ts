...
import { KbqTagModule } from './index';
...
describe('KbqTagInput', () => {
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            imports: [PlatformModule, KbqTagModule, KbqFormFieldModule, NoopAnimationsModule],
        ...
        it('emits (tagEnd) when the separator keys are configured globally', () => {
            ...
            TestBed
                ...
                .configureTestingModule({
                    imports: [KbqTagModule, KbqFormFieldModule, PlatformModule, NoopAnimationsModule],
                    declarations: [TestTagInput],
                    providers: [{
