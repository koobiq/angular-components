...
<Example id="top-bar-title-counter" />
...
<Example id="top-bar-breadcrumbs" />
...
<Example id="top-bar-breadcrumbs-adaptive" />
...
<Example id="top-bar-title-counter-adaptive" />

#### Scroll behavior

The toolbar can remain fixed while scrolling the page.

<Example id="top-bar-overflow" />
