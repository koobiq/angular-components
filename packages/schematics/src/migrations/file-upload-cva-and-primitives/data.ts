...
export const warnPatterns: WarnPattern[] = [
    ...
    },
    {
        ...
        message:
            'KbqInputFileMultipleLabel is deprecated in favour of KbqMultipleFileUploadLocaleConfig. Its ' +
            'index signature only widened the config so an unknown key could be passed to [localeConfig], ' +
