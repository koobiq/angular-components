...
For more information about theme setup and switching, see the [theming](/en/guides/theming) section.
...
For more information, see the [typography](/en/guides/typography) section.
