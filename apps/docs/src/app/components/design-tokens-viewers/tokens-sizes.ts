...
import { docsData } from './data/sizes';
...
@Component({
                    ...
                    <tbody>
                        @for (token of section.tokens; track token.value) {
                            <tr>
                                <td align="left">
                                    <div
                                        class="docs-design-token-example__sizes"
    ...
    host: {
        class: 'docs-design-tokens-sizes'
    },
    imports: [
        KbqDividerModule,
        KbqLinkModule,
...
export class DocsTokensSizes extends DocsTokensBase implements AfterViewInit {
