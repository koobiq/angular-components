...
/**
 * Heading classes of the compiled pages (`tools/docs-pages` and `tools/api-gen`), ordered by depth (h2, h3,
 * h4, h5). The anchor level is the index of the heading's class within this list.
 */
