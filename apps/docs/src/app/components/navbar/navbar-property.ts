...
import { KBQ_LOCAL_STORAGE } from '@koobiq/components/core';
...
export class DocsNavbarProperty {
    ...
    constructor(readonly parameters: DocsNavbarPropertyParameters) {
        ...
        const index =
            parseInt(this.localStorage.getItem(this.parameters.property) || '') ||
    ...
    setValue(index: number): void {
        ...
        this.localStorage.setItem(this.parameters.property, index.toString());
