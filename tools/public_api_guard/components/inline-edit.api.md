...
export class KbqInlineEdit implements KbqConnectedOverlayOriginProvider {
    ...
    protected readonly saveStatus: _angular_core.WritableSignal<KbqInlineEditSaveStatus>;
