...
export class KbqBreadcrumbs {
    ...
    // (undocumented)
    protected readonly hiddenItemIDs: Signal<Set<unknown>>;
    // (undocumented)
    protected readonly items: Signal<readonly KbqBreadcrumbItem[]>;
    ...
    protected readonly maxVisibleItems: Signal<number | null>;
