...
export class Categorizer implements Processor {
    ...
    constructor(private _exportSymbolsToDocsMap: Map<ts.Symbol, ClassLikeExportDoc>) {}
    ...
    private decorateClassDoc(classDoc: CategorizedClassDoc) {
        ...
        } else if (this.isTestHarness(classDoc)) {
     ...
     */
    private isTestHarness(doc: CategorizedClassDoc): boolean {
        return doc.inheritedDocs.some((d: any) => d.name === 'ComponentHarness');
    }
}
