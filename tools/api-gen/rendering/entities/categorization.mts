...
import { ClassEntryRenderable, DocEntryRenderable, InterfaceEntryRenderable } from './renderables.mjs';
...
export function isDeveloperPreview<T extends HasJsDocTags>(entry: T) {
  return entry.jsdocTags.some((tag: JsDocTagEntry) => tag.name === 'developerPreview');
}
