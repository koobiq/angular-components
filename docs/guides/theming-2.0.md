...
Да, необходимо удалить CSS-переменные для компонентов, которые уже используют CSS-переменные со стандартными значениями из коробки.
...
Какие компоненты используют CSS-переменные по умолчанию:
