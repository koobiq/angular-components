...
Все они импортируются из `@koobiq/components/core`. Если подставить `KBQ_STATE_STORE` в `providers` самого
...
Схематики миграции для этого нет: изменение затрагивает реализации хранилищ и провайдеры DI, а не шаблоны.
