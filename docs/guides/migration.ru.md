...
До потребителя ревью доходит в трёх местах: ARIA-семантика триггера и элемента списка, сигнатура публичного метода `activateSafeArea()` и расчёт ширины панели.
...
Схематика для этого ревью нет: каждая строка выше — ручной шаг.
