...
20. **20.3.0**: хранилище состояния аккордеона переехало в `core` и стало общим для всех компонентов.
21. **20.3.0**: сохранение состояния аккордеона включено по умолчанию, ключ выводится из документа.
...
### 20. Хранилище состояния аккордеона переехало в core (20.3.0)
...
### 21. Сохранение состояния аккордеона включено по умолчанию (20.3.0)
