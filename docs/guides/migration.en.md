...
The review reaches a consumer in three places: the ARIA semantics of the trigger and the item, the signature of the public `activateSafeArea()`, and how the panel's width is resolved.
...
No schematic covers this review: every row above is a manual step.
