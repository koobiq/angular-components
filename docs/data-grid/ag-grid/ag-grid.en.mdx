...
<Example id="ag-grid-and-actions-panel" />

### Content panel for the selected row

The [Content panel](/en/components/content-panel) component shows a quick preview of the row selected in the table, shifting the table instead of covering it.

<Example id="ag-grid-and-content-panel" />

### Long lists in cells

A long list can fit into a single line of a cell. [Clamped list](/en/components/clamped-list) expands the hidden items on click, while [Overflow items](/en/components/overflow-items) hides what does not fit the width, so it can be shown in a [Popover](/en/components/popover). To let the row height follow the content, enable `autoHeight` for the column.

<Example id="ag-grid-long-cell-content" />
...
<Example id="ag-grid-copy-selected" />
...
<Example id="ag-grid-column-state" />
...
<Example id="ag-grid-filter-state" />
...
<Example id="ag-grid-quick-filter-state" />
...
<Example id="ag-grid-external-filter-state" />
...
<Example id="ag-grid-row-selection-state" />
...
<Example id="ag-grid-row-focus-state" />
...
<Example id="ag-grid-column-menu" />
...
<Example id="ag-grid-loading-overlay" />
...
<Example id="ag-grid-skeleton-cell-renderer" />
...
<Example id="ag-grid-infinite-selection" />
